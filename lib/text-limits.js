...
export const PROFILE_LIMITS = {
  ...
  LINK_URL: 300,
  // Eboard-typed traits. Six because they stack vertically on a card that
  // already carries a name, a group badge, a role and possibly a bio.
  TRAITS: 6,
  TRAIT_LABEL: 40,
  // Roomier than a link label because it is the content rather than the
  // pointer: "Investment Banking Summer Analyst" is a real answer.
  TRAIT_VALUE: 80,
};
