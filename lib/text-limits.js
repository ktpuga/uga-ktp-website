...
export const PROFILE_LIMITS = {
  ...
  LINK_URL: 300,
  // PRONOUNS_MAX in ktp-api's services/profileFields.js. Only ever binds on a
  // Custom answer, since every preset is far shorter; the API rejects rather
  // than truncates, so capping the input means the limit is felt while typing
  // instead of as a failed save.
  PRONOUNS: 40,
