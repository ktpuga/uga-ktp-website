...
export async function requireEboardAccess() {
...
export async function proxyAdminApi(path, { accessToken, method = 'GET', headers: requestHeaders = {}, body } = {}) {
  if (!API_URL) {
...
export async function proxyAdminMedia(path, { accessToken, range } = {}) {
  if (!API_URL) {
    return errorResponse(500, 'CONFIG_MISSING', 'API URL is not configured.');
  }
