...
// Authentik's own renderer for this flow. The escape hatch for a challenge we
// don't know how to draw, and the thing that makes shipping this safe: an
// unrecognised stage degrades to the page that exists today instead of
// stranding someone at sign-in.
export function fallbackUrl(origin, slug) {
  return `${origin}/if/flow/${encodeURIComponent(slug)}/`;
}
