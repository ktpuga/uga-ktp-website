...
export const HANDLED_COMPONENTS = new Set([
  ...
  'ak-stage-prompt',
  'ak-stage-invitation',
  // Authentik's own refusal, and it must be RENDERED, never handed off. This
  // is what an expired or already-used invitation returns, and sending that
  // person to signIn() would bounce them to a login form for an account they
  // do not have yet — the least useful possible answer to "your invite link
  // has expired". Its `error_message` is written for a person; show it.
