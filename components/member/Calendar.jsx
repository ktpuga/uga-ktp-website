    ...
    const events = [
        {
            ...
            category: 'chapter',
            attendees: 45,
            description: 'Monthly general body meeting to discuss chapter updates and upcoming events.',
        },
        {
            id: 2,
            ...
            attendees: 32,
            description: 'Guest speaker from Google discussing real-world AI implementation.',
        },
        {
            id: 3,
        ...
        },
        {
            ...
            category: 'professional',
            attendees: 38,
            description: 'Professional development workshop focused on resume building and review.',
        },
        {
            id: 5,
            ...
            category: 'service',
            attendees: 22,
            description: 'Volunteer at the local food bank as part of our community service initiative.',
        },
        {
            id: 6,
    ...
    return (<div className="space-y-6">
      ...
      <Tabs defaultValue="all" className="w-full">
        ...
        <TabsContent value="all" className="mt-6">
          <EventsList events={filterEventsByCategory('all')} getEventTypeColor={getEventTypeColor}/>
        </TabsContent>
        <TabsContent value="chapter" className="mt-6">
          <EventsList events={filterEventsByCategory('chapter')} getEventTypeColor={getEventTypeColor}/>
        </TabsContent>
        <TabsContent value="professional" className="mt-6">
          <EventsList events={filterEventsByCategory('professional')} getEventTypeColor={getEventTypeColor}/>
        </TabsContent>
        <TabsContent value="social" className="mt-6">
          <EventsList events={filterEventsByCategory('social')} getEventTypeColor={getEventTypeColor}/>
        </TabsContent>
        <TabsContent value="service" className="mt-6">
          <EventsList events={filterEventsByCategory('service')} getEventTypeColor={getEventTypeColor}/>
        </TabsContent>
      </Tabs>
    </div>);
}
function EventsList({ events, getEventTypeColor }) {
    return (<div className="grid gap-4">
      {events.length === 0 ? (<Card>
        ...
        </Card>) : (events.map((event) => (<Card key={event.id} className="hover:shadow-md transition-shadow">
            <CardHeader>
