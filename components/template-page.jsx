        ...
        <section id="leadership" className="bg-slate-50 py-16 md:py-24">
          ...
          <div className="container mx-auto max-w-6xl px-4 md:px-6" data-aos="fade-up" data-aos-duration="600">
            ...
            <div className="mt-6 grid grid-cols-2 gap-6 text-sm p-0 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4">
              ...
              <Card name="Hayden Crane" title="VP of Internal Affairs" bio="Hayden oversees internal operations and ensures smooth communication among members. A third-year computer science major, Hayden is passionate about technology, leadership, and fostering a supportive KTP community." avatarSrc={images["hayden.jpeg"].default.src} fallbackInitials="HC" instagramUrl="https://www.instagram.com/haydencranee/" linkedinUrl="https://www.linkedin.com/in/hayden-crane-compsci/" />
