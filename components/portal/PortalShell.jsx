...
export default function PortalShell({
  ...
  if (revamped) {
    ...
    const profileRole =
      accent === 'red' ? 'Chapter Administrator' : formatMemberGroup(resolvedGroup);
                ...
                >
                  ...
                  >
                    {profileLoaded ? (
                      ...
                      <>
                        <span aria-hidden="true" className="mt-0.5 block h-3 w-20 rounded bg-muted animate-pulse" />
                        <span aria-hidden="true" className="mt-1.5 block h-2.5 w-14 rounded bg-muted animate-pulse" />
                      </>
                    )}
                  </div>
                </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            {!collapsed && (
              <span className={`font-semibold text-sm ${styles.title}`}>{portalName}</span>
            )}
          </Link>
