                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                  <div className="min-w-0 flex-1">
                    <div className="mb-2 flex flex-wrap items-center gap-2 sm:gap-3">
                      ...
                      <Badge className="shrink-0 bg-gray-100 text-gray-800 dark:bg-slate-800 dark:text-slate-200">Event</Badge>
                    </div>
                    {event.description && (
              ...
              <CardContent className="p-4 pt-0 sm:p-6 sm:pt-0">
                <div className="grid gap-3 sm:grid-cols-2 sm:gap-4">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="min-w-0 text-gray-700 dark:text-gray-300">{formatEventDate(getEventStartDate(event))}</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                ...
                <div className="flex items-start gap-2 text-sm mt-3 pt-3 border-t border-gray-100 dark:border-slate-800">
                  <MapPin className="w-4 h-4 text-gray-500 dark:text-gray-400 mt-0.5 shrink-0" />
                  <span className="text-gray-500 dark:text-gray-400">Location TBD</span>
                </div>
              </CardContent>
            </Card>
          ))}
